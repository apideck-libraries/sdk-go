...
type ApideckCompanies struct {
	rootSDK          *Apideck
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newApideckCompanies(rootSDK *Apideck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *ApideckCompanies {
	return &ApideckCompanies{
		rootSDK:          rootSDK,
