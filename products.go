...
func (s *Products) List(ctx context.Context, request operations.EcommerceProductsAllRequest, opts ...operations.Option) (*operations.EcommerceProductsAllResponse, error) {
	...
	res := &operations.EcommerceProductsAllResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	}
	res.Next = func() (*operations.EcommerceProductsAllResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetProductsResponse
...
// Get Product
// Get Product
func (s *Products) Get(ctx context.Context, id string, serviceID *string, raw *bool, fields *string, opts ...operations.Option) (*operations.EcommerceProductsOneResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	res := &operations.EcommerceProductsOneResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetProductResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
