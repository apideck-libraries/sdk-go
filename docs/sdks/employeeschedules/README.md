...
<!-- UsageSnippet language="go" operationID="hris.employeeSchedulesAll" method="get" path="/hris/schedules/employees/{employee_id}" -->
```go
package main
...
**[*operations.HrisEmployeeSchedulesAllResponse](../../models/operations/hrisemployeeschedulesallresponse.md), error**
