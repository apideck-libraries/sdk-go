...
**[*operations.HrisDepartmentsAllResponse](../../models/operations/hrisdepartmentsallresponse.md), error**
...
func main() {
    ...
    res, err := s.Hris.Departments.Create(ctx, components.DepartmentInput{
...
| --------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| `ctx`                                                                                                                                         | [context.Context](https://pkg.go.dev/context#Context)                                                                                         | :heavy_check_mark:                                                                                                                            | The context to use for the request.                                                                                                           |                                                                                                                                               |
| `department`                                                                                                                                  | [components.DepartmentInput](../../models/components/departmentinput.md)                                                                      | :heavy_check_mark:                                                                                                                            | N/A                                                                                                                                           |                                                                                                                                               |
...
**[*operations.HrisDepartmentsAddResponse](../../models/operations/hrisdepartmentsaddresponse.md), error**
...
func main() {
    ...
    res, err := s.Hris.Departments.Get(ctx, "<id>", sdkgo.String("salesforce"), sdkgo.Bool(false), sdkgo.String("id,updated_at"))
    if err != nil {
        log.Fatal(err)
    }
...
**[*operations.HrisDepartmentsOneResponse](../../models/operations/hrisdepartmentsoneresponse.md), error**
...
func main() {
    ...
    res, err := s.Hris.Departments.Update(ctx, "<id>", components.DepartmentInput{
        Name: sdkgo.String("R&D"),
        Code: sdkgo.String("2"),
        Description: sdkgo.String("R&D"),
        PassThrough: []components.PassThroughBody{
...
**[*operations.HrisDepartmentsUpdateResponse](../../models/operations/hrisdepartmentsupdateresponse.md), error**
...
func main() {
    ...
    res, err := s.Hris.Departments.Delete(ctx, "<id>", sdkgo.String("salesforce"), sdkgo.Bool(false))
    if err != nil {
        log.Fatal(err)
    }
...
**[*operations.HrisDepartmentsDeleteResponse](../../models/operations/hrisdepartmentsdeleteresponse.md), error**
