...
**[*operations.FileStorageSharedLinksAllResponse](../../models/operations/filestoragesharedlinksallresponse.md), error**
...
**[*operations.FileStorageSharedLinksAddResponse](../../models/operations/filestoragesharedlinksaddresponse.md), error**
...
func main() {
    ...
    res, err := s.FileStorage.SharedLinks.Get(ctx, "<id>", sdkgo.String("salesforce"), sdkgo.Bool(false), sdkgo.String("id,updated_at"))
    if err != nil {
        log.Fatal(err)
    }
...
**[*operations.FileStorageSharedLinksOneResponse](../../models/operations/filestoragesharedlinksoneresponse.md), error**
...
**[*operations.FileStorageSharedLinksUpdateResponse](../../models/operations/filestoragesharedlinksupdateresponse.md), error**
...
func main() {
    ...
    res, err := s.FileStorage.SharedLinks.Delete(ctx, "<id>", sdkgo.String("salesforce"), sdkgo.Bool(false))
    if err != nil {
        log.Fatal(err)
    }
...
**[*operations.FileStorageSharedLinksDeleteResponse](../../models/operations/filestoragesharedlinksdeleteresponse.md), error**
