...
<!-- UsageSnippet language="go" operationID="hris.payrollsAll" method="get" path="/hris/payrolls" -->
```go
package main
...
<!-- UsageSnippet language="go" operationID="hris.payrollsOne" method="get" path="/hris/payrolls/{payroll_id}" -->
```go
package main
