...
func main() {
    ...
    res, err := s.Sms.Messages.Get(ctx, "<id>", sdkgo.String("salesforce"), sdkgo.Bool(false), sdkgo.String("id,updated_at"))
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Sms.Messages.Delete(ctx, "<id>", sdkgo.String("salesforce"), sdkgo.Bool(false))
    if err != nil {
        log.Fatal(err)
    }
