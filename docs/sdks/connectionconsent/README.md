...
<!-- UsageSnippet language="go" operationID="vault.connectionConsentUpdate" method="patch" path="/vault/connections/{unified_api}/{service_id}/consent" -->
```go
package main
...
**[*operations.VaultConnectionConsentUpdateResponse](../../models/operations/vaultconnectionconsentupdateresponse.md), error**
