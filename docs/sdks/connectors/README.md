...
func main() {
    ...
    res, err := s.Connector.Connectors.List(ctx, sdkgo.String("dSBdXd2H6Mqwfg0atXHXYcysLJE9qyn1VwBtXHX"), nil, nil, &components.ConnectorsFilter{
...
func main() {
    ...
    res, err := s.Connector.Connectors.Get(ctx, "<id>", sdkgo.String("dSBdXd2H6Mqwfg0atXHXYcysLJE9qyn1VwBtXHX"))
    if err != nil {
        log.Fatal(err)
    }
