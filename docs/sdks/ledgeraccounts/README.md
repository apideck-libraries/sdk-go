...
func main() {
    ...
    res, err := s.Accounting.LedgerAccounts.Create(ctx, components.LedgerAccountInput{
...
func main() {
    ...
    res, err := s.Accounting.LedgerAccounts.Get(ctx, "<id>", sdkgo.String("salesforce"), nil, sdkgo.String("id,updated_at"))
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Accounting.LedgerAccounts.Update(ctx, "<id>", components.LedgerAccountInput{
        DisplayID: sdkgo.String("1-12345"),
        Code: sdkgo.String("453"),
        Classification: components.ClassificationAsset.ToPointer(),
        Type: components.LedgerAccountTypeBank.ToPointer(),
...
func main() {
    ...
    res, err := s.Accounting.LedgerAccounts.Delete(ctx, "<id>", sdkgo.String("salesforce"), nil)
    if err != nil {
        log.Fatal(err)
    }
