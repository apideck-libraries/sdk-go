...
func main() {
    ...
    res, err := s.Accounting.PurchaseOrders.Get(ctx, "<id>", sdkgo.String("salesforce"), nil)
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Accounting.PurchaseOrders.Delete(ctx, "<id>", sdkgo.String("salesforce"), nil)
    if err != nil {
        log.Fatal(err)
    }
