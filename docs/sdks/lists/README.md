...
<!-- UsageSnippet language="go" operationID="crm.listsAll" method="get" path="/crm/lists" -->
```go
package main
...
**[*operations.CrmListsAllResponse](../../models/operations/crmlistsallresponse.md), error**
...
<!-- UsageSnippet language="go" operationID="crm.listsOne" method="get" path="/crm/lists/{id}" -->
```go
package main
...
**[*operations.CrmListsOneResponse](../../models/operations/crmlistsoneresponse.md), error**
