...
<!-- UsageSnippet language="go" operationID="issueTracking.collectionsAll" method="get" path="/issue-tracking/collections" -->
```go
package main
...
<!-- UsageSnippet language="go" operationID="issueTracking.collectionsOne" method="get" path="/issue-tracking/collections/{collection_id}" -->
```go
package main
