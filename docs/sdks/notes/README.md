...
**[*operations.CrmNotesAllResponse](../../models/operations/crmnotesallresponse.md), error**
...
func main() {
    ...
    res, err := s.Crm.Notes.Create(ctx, components.NoteInput{
...
**[*operations.CrmNotesAddResponse](../../models/operations/crmnotesaddresponse.md), error**
...
func main() {
    ...
    res, err := s.Crm.Notes.Get(ctx, "<id>", sdkgo.String("salesforce"), sdkgo.Bool(false), sdkgo.String("id,updated_at"))
    if err != nil {
        log.Fatal(err)
    }
...
**[*operations.CrmNotesOneResponse](../../models/operations/crmnotesoneresponse.md), error**
...
func main() {
    ...
    res, err := s.Crm.Notes.Update(ctx, "<id>", components.NoteInput{
        Title: sdkgo.String("Meeting Notes"),
        Content: sdkgo.String("Office hours are 9AM-6PM"),
        OwnerID: sdkgo.String("12345"),
        ContactID: sdkgo.String("12345"),
...
**[*operations.CrmNotesUpdateResponse](../../models/operations/crmnotesupdateresponse.md), error**
...
func main() {
    ...
    res, err := s.Crm.Notes.Delete(ctx, "<id>", sdkgo.String("salesforce"), sdkgo.Bool(false))
    if err != nil {
        log.Fatal(err)
    }
...
**[*operations.CrmNotesDeleteResponse](../../models/operations/crmnotesdeleteresponse.md), error**
