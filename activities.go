...
func newActivities(rootSDK *Apideck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Activities {
	return &Activities{
		rootSDK:          rootSDK,
...
func (s *Activities) List(ctx context.Context, request operations.CrmActivitiesAllRequest, opts ...operations.Option) (*operations.CrmActivitiesAllResponse, error) {
	...
	res := &operations.CrmActivitiesAllResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	}
	res.Next = func() (*operations.CrmActivitiesAllResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetActivitiesResponse
...
func (s *Activities) Create(ctx context.Context, request operations.CrmActivitiesAddRequest, opts ...operations.Option) (*operations.CrmActivitiesAddResponse, error) {
	...
	res := &operations.CrmActivitiesAddResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.CreateActivityResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *Activities) Get(ctx context.Context, request operations.CrmActivitiesOneRequest, opts ...operations.Option) (*operations.CrmActivitiesOneResponse, error) {
	...
	res := &operations.CrmActivitiesOneResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetActivityResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *Activities) Update(ctx context.Context, request operations.CrmActivitiesUpdateRequest, opts ...operations.Option) (*operations.CrmActivitiesUpdateResponse, error) {
	...
	res := &operations.CrmActivitiesUpdateResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.UpdateActivityResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *Activities) Delete(ctx context.Context, request operations.CrmActivitiesDeleteRequest, opts ...operations.Option) (*operations.CrmActivitiesDeleteResponse, error) {
	...
	res := &operations.CrmActivitiesDeleteResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.DeleteActivityResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
