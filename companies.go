...
func newCompanies(rootSDK *Apideck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Companies {
	return &Companies{
		rootSDK:          rootSDK,
...
func (s *Companies) List(ctx context.Context, request operations.AccountingCompaniesAllRequest, opts ...operations.Option) (*operations.AccountingCompaniesAllResponse, error) {
	globals := operations.AccountingCompaniesAllGlobals{
	...
	opURL, err := url.JoinPath(baseURL, "/accounting/companies")
	if err != nil {
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "accounting.companiesAll",
		OAuth2Scopes:     nil,
	...
	res := &operations.AccountingCompaniesAllResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	}
	res.Next = func() (*operations.AccountingCompaniesAllResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetCompaniesResponse
