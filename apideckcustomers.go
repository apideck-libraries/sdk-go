...
type ApideckCustomers struct {
	rootSDK          *Apideck
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newApideckCustomers(rootSDK *Apideck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *ApideckCustomers {
	return &ApideckCustomers{
		rootSDK:          rootSDK,
...
func (s *ApideckCustomers) List(ctx context.Context, request operations.EcommerceCustomersAllRequest, opts ...operations.Option) (*operations.EcommerceCustomersAllResponse, error) {
	...
	res := &operations.EcommerceCustomersAllResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	}
	res.Next = func() (*operations.EcommerceCustomersAllResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetEcommerceCustomersResponse
...
func (s *ApideckCustomers) Get(ctx context.Context, request operations.EcommerceCustomersOneRequest, opts ...operations.Option) (*operations.EcommerceCustomersOneResponse, error) {
	...
	res := &operations.EcommerceCustomersOneResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetEcommerceCustomerResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
