...
func newValidateConnection(rootSDK *Apideck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *ValidateConnection {
...
func (s *ValidateConnection) State(ctx context.Context, request operations.VaultValidateConnectionStateRequest, opts ...operations.Option) (*operations.VaultValidateConnectionStateResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/vault/connections/{unified_api}/{service_id}/validate", request, globals)
	if err != nil {
	...
	res := &operations.VaultValidateConnectionStateResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.ValidateConnectionStateResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.ValidateConnectionStateResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
