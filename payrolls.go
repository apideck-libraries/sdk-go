...
func newPayrolls(rootSDK *Apideck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Payrolls {
	return &Payrolls{
		rootSDK:          rootSDK,
...
func (s *Payrolls) List(ctx context.Context, request operations.HrisPayrollsAllRequest, opts ...operations.Option) (*operations.HrisPayrollsAllResponse, error) {
	...
	res := &operations.HrisPayrollsAllResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetPayrollsResponse
...
func (s *Payrolls) Get(ctx context.Context, request operations.HrisPayrollsOneRequest, opts ...operations.Option) (*operations.HrisPayrollsOneResponse, error) {
	...
	res := &operations.HrisPayrollsOneResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetPayrollResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
