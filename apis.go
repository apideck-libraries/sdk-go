...
func newApis(rootSDK *Apideck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Apis {
	return &Apis{
		rootSDK:          rootSDK,
...
func (s *Apis) List(ctx context.Context, appID *string, cursor *string, limit *int64, filter *components.ApisFilter, opts ...operations.Option) (*operations.ConnectorApisAllResponse, error) {
	...
	globals := operations.ConnectorApisAllGlobals{
	...
	res := &operations.ConnectorApisAllResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	}
	res.Next = func() (*operations.ConnectorApisAllResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetApisResponse
...
func (s *Apis) Get(ctx context.Context, id string, appID *string, opts ...operations.Option) (*operations.ConnectorApisOneResponse, error) {
	...
	res := &operations.ConnectorApisOneResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetAPIResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
