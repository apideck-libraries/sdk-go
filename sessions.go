...
func newSessions(rootSDK *Apideck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Sessions {
	return &Sessions{
		rootSDK:          rootSDK,
...
func (s *Sessions) Create(ctx context.Context, consumerID *string, appID *string, session *components.Session, opts ...operations.Option) (*operations.VaultSessionsCreateResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/vault/sessions")
	if err != nil {
	...
	res := &operations.VaultSessionsCreateResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.CreateSessionResponse
