...
func newAPIResources(rootSDK *Apideck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *APIResources {
	return &APIResources{
		rootSDK:          rootSDK,
...
func (s *APIResources) Get(ctx context.Context, id string, resourceID string, appID *string, opts ...operations.Option) (*operations.ConnectorAPIResourcesOneResponse, error) {
	...
	globals := operations.ConnectorAPIResourcesOneGlobals{
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/connector/apis/{id}/resources/{resource_id}", request, globals)
	if err != nil {
	...
	res := &operations.ConnectorAPIResourcesOneResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetAPIResourceResponse
