...
func newLogs(rootSDK *Apideck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Logs {
	return &Logs{
		rootSDK:          rootSDK,
...
func (s *Logs) List(ctx context.Context, request operations.VaultLogsAllRequest, opts ...operations.Option) (*operations.VaultLogsAllResponse, error) {
	...
	res := &operations.VaultLogsAllResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	}
	res.Next = func() (*operations.VaultLogsAllResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetLogsResponse
