...
func newConnectorResources(rootSDK *Apideck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *ConnectorResources {
...
func (s *ConnectorResources) Get(ctx context.Context, id string, resourceID string, appID *string, unifiedAPI *components.UnifiedAPIID, opts ...operations.Option) (*operations.ConnectorConnectorResourcesOneResponse, error) {
	...
	globals := operations.ConnectorConnectorResourcesOneGlobals{
	...
	res := &operations.ConnectorConnectorResourcesOneResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetConnectorResourceResponse
