...
func newCompanyInfo(rootSDK *Apideck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *CompanyInfo {
	return &CompanyInfo{
		rootSDK:          rootSDK,
...
func (s *CompanyInfo) Get(ctx context.Context, request operations.AccountingCompanyInfoOneRequest, opts ...operations.Option) (*operations.AccountingCompanyInfoOneResponse, error) {
	...
	res := &operations.AccountingCompanyInfoOneResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetCompanyInfoResponse
