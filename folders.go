...
func newFolders(rootSDK *Apideck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Folders {
	return &Folders{
		rootSDK:          rootSDK,
...
func (s *Folders) Create(ctx context.Context, request operations.FileStorageFoldersAddRequest, opts ...operations.Option) (*operations.FileStorageFoldersAddResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/file-storage/folders")
	if err != nil {
	...
	res := &operations.FileStorageFoldersAddResponse{
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.CreateFolderResponse
...
func (s *Folders) Get(ctx context.Context, request operations.FileStorageFoldersOneRequest, opts ...operations.Option) (*operations.FileStorageFoldersOneResponse, error) {
	...
	res := &operations.FileStorageFoldersOneResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetFolderResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *Folders) Update(ctx context.Context, request operations.FileStorageFoldersUpdateRequest, opts ...operations.Option) (*operations.FileStorageFoldersUpdateResponse, error) {
	...
	res := &operations.FileStorageFoldersUpdateResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.UpdateFolderResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *Folders) Delete(ctx context.Context, request operations.FileStorageFoldersDeleteRequest, opts ...operations.Option) (*operations.FileStorageFoldersDeleteResponse, error) {
	...
	res := &operations.FileStorageFoldersDeleteResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.DeleteFolderResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *Folders) Copy(ctx context.Context, request operations.FileStorageFoldersCopyRequest, opts ...operations.Option) (*operations.FileStorageFoldersCopyResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/file-storage/folders/{id}/copy", request, globals)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.FileStorageFoldersCopyResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
