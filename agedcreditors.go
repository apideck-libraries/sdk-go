...
func newAgedCreditors(rootSDK *Apideck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *AgedCreditors {
...
// Get Aged Creditors
// Get Aged Creditors
func (s *AgedCreditors) Get(ctx context.Context, request operations.AccountingAgedCreditorsOneRequest, opts ...operations.Option) (*operations.AccountingAgedCreditorsOneResponse, error) {
	globals := operations.AccountingAgedCreditorsOneGlobals{
	...
	res := &operations.AccountingAgedCreditorsOneResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetAgedCreditorsResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.GetAgedCreditorsResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
