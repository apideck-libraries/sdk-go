...
func newJobs(rootSDK *Apideck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Jobs {
	return &Jobs{
		rootSDK:          rootSDK,
...
func (s *Jobs) List(ctx context.Context, request operations.AtsJobsAllRequest, opts ...operations.Option) (*operations.AtsJobsAllResponse, error) {
	...
	res := &operations.AtsJobsAllResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	}
	res.Next = func() (*operations.AtsJobsAllResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetJobsResponse
...
// Create Job
// Create Job
func (s *Jobs) Create(ctx context.Context, request operations.AtsJobsAddRequest, opts ...operations.Option) (*operations.AtsJobsAddResponse, error) {
	globals := operations.AtsJobsAddGlobals{
		ConsumerID: s.sdkConfiguration.Globals.ConsumerID,
		AppID:      s.sdkConfiguration.Globals.AppID,
	}
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "ats.jobsAdd",
		OAuth2Scopes:     nil,
		SecuritySource:   s.sdkConfiguration.Security,
	}
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "Job", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	res := &operations.AtsJobsAddResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.CreateJobResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *Jobs) Get(ctx context.Context, request operations.AtsJobsOneRequest, opts ...operations.Option) (*operations.AtsJobsOneResponse, error) {
	...
	res := &operations.AtsJobsOneResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetJobResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
// Update Job
// Update Job
func (s *Jobs) Update(ctx context.Context, request operations.AtsJobsUpdateRequest, opts ...operations.Option) (*operations.AtsJobsUpdateResponse, error) {
	globals := operations.AtsJobsUpdateGlobals{
		ConsumerID: s.sdkConfiguration.Globals.ConsumerID,
		AppID:      s.sdkConfiguration.Globals.AppID,
	}
	...
	res := &operations.AtsJobsUpdateResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.UpdateJobResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
// Delete Job
// Delete Job
func (s *Jobs) Delete(ctx context.Context, request operations.AtsJobsDeleteRequest, opts ...operations.Option) (*operations.AtsJobsDeleteResponse, error) {
	globals := operations.AtsJobsDeleteGlobals{
		ConsumerID: s.sdkConfiguration.Globals.ConsumerID,
		AppID:      s.sdkConfiguration.Globals.AppID,
	}
	...
	res := &operations.AtsJobsDeleteResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.DeleteJobResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
