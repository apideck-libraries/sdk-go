...
type AccountingJournalEntriesAllGlobals struct {
...
type AccountingJournalEntriesAllRequest struct {
	...
	// Apply filters
	Filter *components.JournalEntriesFilter `queryParam:"style=deepObject,explode=true,name=filter"`
	// Apply sorting
	Sort *components.JournalEntriesSort `queryParam:"style=deepObject,explode=true,name=sort"`
...
func (a AccountingJournalEntriesAllRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(a, "", false)
}

func (a *AccountingJournalEntriesAllRequest) UnmarshalJSON(data []byte) error {
...
func (a *AccountingJournalEntriesAllRequest) GetCompanyID() *string {
	if a == nil {
		return nil
	}
	return a.CompanyID
