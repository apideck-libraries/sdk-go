...
type AccountingBillsOneGlobals struct {
...
func (a AccountingBillsOneRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(a, "", false)
}

func (a *AccountingBillsOneRequest) UnmarshalJSON(data []byte) error {
...
func (a *AccountingBillsOneRequest) GetCompanyID() *string {
	if a == nil {
		return nil
	}
	return a.CompanyID
...
type AccountingBillsOneResponse struct {
	...
	// Bill
	GetBillResponse *components.GetBillResponse
	// Unexpected error
