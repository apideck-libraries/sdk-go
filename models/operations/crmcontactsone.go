...
type CrmContactsOneGlobals struct {
...
func (c CrmContactsOneRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(c, "", false)
}

func (c *CrmContactsOneRequest) UnmarshalJSON(data []byte) error {
...
type CrmContactsOneResponse struct {
	...
	// Contact
	GetContactResponse *components.GetContactResponse
	// Unexpected error
