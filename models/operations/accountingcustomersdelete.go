...
type AccountingCustomersDeleteGlobals struct {
...
func (a AccountingCustomersDeleteRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(a, "", false)
}

func (a *AccountingCustomersDeleteRequest) UnmarshalJSON(data []byte) error {
...
type AccountingCustomersDeleteResponse struct {
	...
	// Customers
	DeleteCustomerResponse *components.DeleteCustomerResponse
	// Unexpected error
