...
type AccountingSuppliersOneGlobals struct {
...
func (a AccountingSuppliersOneRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(a, "", false)
}

func (a *AccountingSuppliersOneRequest) UnmarshalJSON(data []byte) error {
...
func (a *AccountingSuppliersOneRequest) GetCompanyID() *string {
	if a == nil {
		return nil
	}
	return a.CompanyID
...
type AccountingSuppliersOneResponse struct {
	...
	// Supplier
	GetSupplierResponse *components.GetSupplierResponse
	// Unexpected error
