...
type AccountingCreditNotesOneGlobals struct {
...
func (a AccountingCreditNotesOneRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(a, "", false)
}

func (a *AccountingCreditNotesOneRequest) UnmarshalJSON(data []byte) error {
...
func (a *AccountingCreditNotesOneRequest) GetCompanyID() *string {
	if a == nil {
		return nil
	}
	return a.CompanyID
...
type AccountingCreditNotesOneResponse struct {
	...
	// Credit Note
	GetCreditNoteResponse *components.GetCreditNoteResponse
	// Unexpected error
