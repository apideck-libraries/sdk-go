...
type CrmLeadsOneGlobals struct {
...
func (c CrmLeadsOneRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(c, "", false)
}

func (c *CrmLeadsOneRequest) UnmarshalJSON(data []byte) error {
...
type CrmLeadsOneResponse struct {
	...
	// Lead
	GetLeadResponse *components.GetLeadResponse
	// Unexpected error
