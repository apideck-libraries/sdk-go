...
type CustomFieldValue25 struct {
	...
	MapOfAny map[string]any `queryParam:"inline,name=five" union:"member"`
...
type CustomFieldValue struct {
	...
	ArrayOfCustomFieldValue25 []*CustomFieldValue25 `queryParam:"inline,name=value" union:"member"`
...
type CustomField1Value struct {
	...
	Boolean                  *bool                `queryParam:"inline,name=value" union:"member"`
	MapOfAny                 map[string]any       `queryParam:"inline,name=value" union:"member"`
	ArrayOfCustomFieldValue5 []*CustomFieldValue5 `queryParam:"inline,name=value" union:"member"`
...
type CustomField struct {
	CustomField1 *CustomField1 `queryParam:"inline,name=CustomField" union:"member"`
	CustomField2 *CustomField2 `queryParam:"inline,name=CustomField" union:"member"`
