...
type Five struct {
	...
	Integer *int64   `queryParam:"inline,name=five" union:"member"`
...
type Value struct {
	...
	Integer  *int64   `queryParam:"inline,name=value" union:"member"`
	Number   *float64 `queryParam:"inline,name=value" union:"member"`
	Boolean  *bool    `queryParam:"inline,name=value" union:"member"`
	ArrayOf5 []Five   `queryParam:"inline,name=value" union:"member"`
