...
type DataScopesResources struct {
	MapOfMapOfDataScopesResources1 map[string]map[string]DataScopesResources1 `queryParam:"inline,name=DataScopesResources" union:"member"`
	DataScopesResources2           *DataScopesResources2                      `queryParam:"inline,name=DataScopesResources" union:"member"`
