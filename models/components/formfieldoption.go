...
type FormFieldOption struct {
	SimpleFormFieldOption *SimpleFormFieldOption `queryParam:"inline,name=FormFieldOption" union:"member"`
	FormFieldOptionGroup  *FormFieldOptionGroup  `queryParam:"inline,name=FormFieldOption" union:"member"`
