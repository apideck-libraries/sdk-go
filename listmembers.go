...
func newListMembers(rootSDK *Apideck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *ListMembers {
	return &ListMembers{
		rootSDK:          rootSDK,
...
func (s *ListMembers) List(ctx context.Context, request operations.CrmListMembersAllRequest, opts ...operations.Option) (*operations.CrmListMembersAllResponse, error) {
	globals := operations.CrmListMembersAllGlobals{
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/crm/lists/{id}/members", request, globals)
	if err != nil {
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "crm.listMembersAll",
		OAuth2Scopes:     nil,
	...
	res := &operations.CrmListMembersAllResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	}
	res.Next = func() (*operations.CrmListMembersAllResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetListMembersResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.GetListMembersResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
