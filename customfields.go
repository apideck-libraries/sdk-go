...
func newCustomFields(rootSDK *Apideck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *CustomFields {
	return &CustomFields{
		rootSDK:          rootSDK,
...
func (s *CustomFields) List(ctx context.Context, request operations.VaultCustomFieldsAllRequest, opts ...operations.Option) (*operations.VaultCustomFieldsAllResponse, error) {
	...
	res := &operations.VaultCustomFieldsAllResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetCustomFieldsResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.GetCustomFieldsResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
