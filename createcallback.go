...
func newCreateCallback(rootSDK *Apideck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *CreateCallback {
...
func (s *CreateCallback) State(ctx context.Context, request operations.VaultCreateCallbackStateRequest, opts ...operations.Option) (*operations.VaultCreateCallbackStateResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/vault/connections/{unified_api}/{service_id}/callback-state", request, globals)
	if err != nil {
	...
	res := &operations.VaultCreateCallbackStateResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.CreateCallbackStateResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.CreateCallbackStateResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
