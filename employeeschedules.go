...
func newEmployeeSchedules(rootSDK *Apideck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *EmployeeSchedules {
...
func (s *EmployeeSchedules) List(ctx context.Context, request operations.HrisEmployeeSchedulesAllRequest, opts ...operations.Option) (*operations.HrisEmployeeSchedulesAllResponse, error) {
	...
	res := &operations.HrisEmployeeSchedulesAllResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetEmployeeSchedulesResponse
