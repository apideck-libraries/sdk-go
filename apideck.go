...
// Generated from OpenAPI doc version 10.23.1 and generator version 2.781.2
...
func New(opts ...SDKOption) *Apideck {
	sdk := &Apideck{
		SDKVersion: "0.25.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.25.0 2.781.2 10.23.1 github.com/apideck-libraries/sdk-go",
