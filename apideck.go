...
// Generated from OpenAPI doc version 10.24.9 and generator version 2.869.25
...
func New(opts ...SDKOption) *Apideck {
	sdk := &Apideck{
		SDKVersion: "0.27.3",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.27.3 2.869.25 10.24.9 github.com/apideck-libraries/sdk-go",
