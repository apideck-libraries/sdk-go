...
// Generated from OpenAPI doc version 10.21.14 and generator version 2.748.0
...
func New(opts ...SDKOption) *Apideck {
	sdk := &Apideck{
		SDKVersion: "0.23.4",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.23.4 2.748.0 10.21.14 github.com/apideck-libraries/sdk-go",
