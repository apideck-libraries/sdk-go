...
// Generated from OpenAPI doc version 10.24.23 and generator version 2.881.0
...
func New(opts ...SDKOption) *Apideck {
	sdk := &Apideck{
		SDKVersion: "0.27.10",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.27.10 2.881.0 10.24.23 github.com/apideck-libraries/sdk-go",
