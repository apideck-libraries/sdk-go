...
// Generated from OpenAPI doc version 10.24.0 and generator version 2.845.21
...
func New(opts ...SDKOption) *Apideck {
	sdk := &Apideck{
		SDKVersion: "0.27.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.27.0 2.845.21 10.24.0 github.com/apideck-libraries/sdk-go",
