...
// Generated from OpenAPI doc version 10.23.3 and generator version 2.788.7
...
func New(opts ...SDKOption) *Apideck {
	sdk := &Apideck{
		SDKVersion: "0.25.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.25.0 2.788.7 10.23.3 github.com/apideck-libraries/sdk-go",
