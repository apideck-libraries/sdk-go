...
// Generated from OpenAPI doc version 10.24.3 and generator version 2.858.2
...
func New(opts ...SDKOption) *Apideck {
	sdk := &Apideck{
		SDKVersion: "0.27.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.27.0 2.858.2 10.24.3 github.com/apideck-libraries/sdk-go",
