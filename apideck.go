...
// Generated from OpenAPI doc version 10.20.12 and generator version 2.687.13
...
func New(opts ...SDKOption) *Apideck {
	sdk := &Apideck{
		SDKVersion: "0.17.7",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.17.7 2.687.13 10.20.12 github.com/apideck-libraries/sdk-go",
