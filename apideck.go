...
// Generated from OpenAPI doc version 10.20.1 and generator version 2.672.0
...
func New(opts ...SDKOption) *Apideck {
	sdk := &Apideck{
		SDKVersion: "0.17.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.17.0 2.672.0 10.20.1 github.com/apideck-libraries/sdk-go",
