...
// Generated from OpenAPI doc version 10.20.11 and generator version 2.687.1
...
func New(opts ...SDKOption) *Apideck {
	sdk := &Apideck{
		SDKVersion: "0.17.6",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.17.6 2.687.1 10.20.11 github.com/apideck-libraries/sdk-go",
