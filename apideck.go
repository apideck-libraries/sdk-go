...
// Generated from OpenAPI doc version 10.21.2 and generator version 2.716.16
...
func New(opts ...SDKOption) *Apideck {
	sdk := &Apideck{
		SDKVersion: "0.19.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.19.0 2.716.16 10.21.2 github.com/apideck-libraries/sdk-go",
