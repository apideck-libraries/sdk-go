...
// Generated from OpenAPI doc version 10.23.11 and generator version 2.801.0
...
func New(opts ...SDKOption) *Apideck {
	sdk := &Apideck{
		SDKVersion: "0.26.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.26.0 2.801.0 10.23.11 github.com/apideck-libraries/sdk-go",
