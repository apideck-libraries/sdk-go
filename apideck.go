...
// Generated from OpenAPI doc version 10.24.29 and generator version 2.881.4
...
func New(opts ...SDKOption) *Apideck {
	sdk := &Apideck{
		SDKVersion: "0.27.11",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.27.11 2.881.4 10.24.29 github.com/apideck-libraries/sdk-go",
