...
// Generated from OpenAPI doc version 10.32.0 and generator version 2.926.8
...
func New(opts ...SDKOption) *Apideck {
	sdk := &Apideck{
		SDKVersion: "0.30.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.30.0 2.926.8 10.32.0 github.com/apideck-libraries/sdk-go",
