...
// Generated from OpenAPI doc version 10.24.44 and generator version 2.911.0
...
func New(opts ...SDKOption) *Apideck {
	sdk := &Apideck{
		SDKVersion: "0.27.17",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.27.17 2.911.0 10.24.44 github.com/apideck-libraries/sdk-go",
