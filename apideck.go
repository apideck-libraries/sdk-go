...
// Generated from OpenAPI doc version 10.24.45 and generator version 2.912.1
...
func New(opts ...SDKOption) *Apideck {
	sdk := &Apideck{
		SDKVersion: "0.27.19",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.27.19 2.912.1 10.24.45 github.com/apideck-libraries/sdk-go",
