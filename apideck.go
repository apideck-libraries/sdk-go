...
// Generated from OpenAPI doc version 10.24.45 and generator version 2.911.3
...
func New(opts ...SDKOption) *Apideck {
	sdk := &Apideck{
		SDKVersion: "0.27.18",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.27.18 2.911.3 10.24.45 github.com/apideck-libraries/sdk-go",
