...
// Generated from OpenAPI doc version 10.17.2 and generator version 2.629.1
...
func New(opts ...SDKOption) *Apideck {
	sdk := &Apideck{
		SDKVersion: "0.13.1",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.13.1 2.629.1 10.17.2 github.com/apideck-libraries/sdk-go",
