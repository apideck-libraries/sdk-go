...
// Generated from OpenAPI doc version 10.24.7 and generator version 2.869.10
...
func New(opts ...SDKOption) *Apideck {
	sdk := &Apideck{
		SDKVersion: "0.27.1",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.27.1 2.869.10 10.24.7 github.com/apideck-libraries/sdk-go",
