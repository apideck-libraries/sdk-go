...
// Generated from OpenAPI doc version 10.18.4 and generator version 2.660.0
...
func New(opts ...SDKOption) *Apideck {
	sdk := &Apideck{
		SDKVersion: "0.16.3",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.16.3 2.660.0 10.18.4 github.com/apideck-libraries/sdk-go",
