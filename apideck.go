...
// Generated from OpenAPI doc version 10.18.1 and generator version 2.648.7
...
func New(opts ...SDKOption) *Apideck {
	sdk := &Apideck{
		SDKVersion: "0.16.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.16.0 2.648.7 10.18.1 github.com/apideck-libraries/sdk-go",
