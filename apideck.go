...
// Generated from OpenAPI doc version 10.20.2 and generator version 2.674.1
...
func New(opts ...SDKOption) *Apideck {
	sdk := &Apideck{
		SDKVersion: "0.17.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.17.0 2.674.1 10.20.2 github.com/apideck-libraries/sdk-go",
