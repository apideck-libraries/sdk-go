...
// Generated from OpenAPI doc version 10.52.0 and generator version 2.935.1
...
func New(opts ...SDKOption) *Apideck {
	sdk := &Apideck{
		SDKVersion: "0.34.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:         "speakeasy-sdk/go 0.34.0 2.935.1 10.52.0 github.com/apideck-libraries/sdk-go",
			SDKVersion:        "0.34.0",
			GenVersion:        "2.935.1",
			OpenAPIDocVersion: "10.52.0",
