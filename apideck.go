...
// Generated from OpenAPI doc version 10.21.7 and generator version 2.731.6
...
func New(opts ...SDKOption) *Apideck {
	sdk := &Apideck{
		SDKVersion: "0.22.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.22.0 2.731.6 10.21.7 github.com/apideck-libraries/sdk-go",
