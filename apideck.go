...
// Generated from OpenAPI doc version 10.24.8 and generator version 2.869.25
...
func New(opts ...SDKOption) *Apideck {
	sdk := &Apideck{
		SDKVersion: "0.27.2",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.27.2 2.869.25 10.24.8 github.com/apideck-libraries/sdk-go",
