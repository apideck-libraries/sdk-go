...
// Generated from OpenAPI doc version 10.23.13 and generator version 2.811.4
...
func New(opts ...SDKOption) *Apideck {
	sdk := &Apideck{
		SDKVersion: "0.26.1",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.26.1 2.811.4 10.23.13 github.com/apideck-libraries/sdk-go",
