...
// Generated from OpenAPI doc version 10.20.10 and generator version 2.686.7
...
func New(opts ...SDKOption) *Apideck {
	sdk := &Apideck{
		SDKVersion: "0.17.5",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.17.5 2.686.7 10.20.10 github.com/apideck-libraries/sdk-go",
