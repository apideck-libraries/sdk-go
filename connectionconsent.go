...
func newConnectionConsent(rootSDK *Apideck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *ConnectionConsent {
...
func (s *ConnectionConsent) Update(ctx context.Context, request operations.VaultConnectionConsentUpdateRequest, opts ...operations.Option) (*operations.VaultConnectionConsentUpdateResponse, error) {
	globals := operations.VaultConnectionConsentUpdateGlobals{
	...
	res := &operations.VaultConnectionConsentUpdateResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.UpdateConsentResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.UpdateConsentResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
