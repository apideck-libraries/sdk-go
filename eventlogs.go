...
func newEventLogs(rootSDK *Apideck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *EventLogs {
	return &EventLogs{
		rootSDK:          rootSDK,
...
func (s *EventLogs) List(ctx context.Context, appID *string, cursor *string, limit *int64, filter *components.WebhookEventLogsFilter, opts ...operations.Option) (*operations.WebhookEventLogsAllResponse, error) {
	...
	globals := operations.WebhookEventLogsAllGlobals{
	...
	res := &operations.WebhookEventLogsAllResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	}
	res.Next = func() (*operations.WebhookEventLogsAllResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetWebhookEventLogsResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.GetWebhookEventLogsResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
