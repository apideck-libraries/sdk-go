...
func newCollections(rootSDK *Apideck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Collections {
	return &Collections{
		rootSDK:          rootSDK,
...
func (s *Collections) List(ctx context.Context, request operations.IssueTrackingCollectionsAllRequest, opts ...operations.Option) (*operations.IssueTrackingCollectionsAllResponse, error) {
	...
	res := &operations.IssueTrackingCollectionsAllResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	}
	res.Next = func() (*operations.IssueTrackingCollectionsAllResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetCollectionsResponse
...
func (s *Collections) Get(ctx context.Context, request operations.IssueTrackingCollectionsOneRequest, opts ...operations.Option) (*operations.IssueTrackingCollectionsOneResponse, error) {
	...
	res := &operations.IssueTrackingCollectionsOneResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
