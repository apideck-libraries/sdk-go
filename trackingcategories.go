...
func newTrackingCategories(rootSDK *Apideck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *TrackingCategories {
...
func (s *TrackingCategories) List(ctx context.Context, request operations.AccountingTrackingCategoriesAllRequest, opts ...operations.Option) (*operations.AccountingTrackingCategoriesAllResponse, error) {
	...
	res := &operations.AccountingTrackingCategoriesAllResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	}
	res.Next = func() (*operations.AccountingTrackingCategoriesAllResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetTrackingCategoriesResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.GetTrackingCategoriesResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *TrackingCategories) Create(ctx context.Context, request operations.AccountingTrackingCategoriesAddRequest, opts ...operations.Option) (*operations.AccountingTrackingCategoriesAddResponse, error) {
	...
	res := &operations.AccountingTrackingCategoriesAddResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.CreateTrackingCategoryResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.CreateTrackingCategoryResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *TrackingCategories) Get(ctx context.Context, request operations.AccountingTrackingCategoriesOneRequest, opts ...operations.Option) (*operations.AccountingTrackingCategoriesOneResponse, error) {
	...
	res := &operations.AccountingTrackingCategoriesOneResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetTrackingCategoryResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.GetTrackingCategoryResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *TrackingCategories) Update(ctx context.Context, request operations.AccountingTrackingCategoriesUpdateRequest, opts ...operations.Option) (*operations.AccountingTrackingCategoriesUpdateResponse, error) {
	...
	res := &operations.AccountingTrackingCategoriesUpdateResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.UpdateTrackingCategoryResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.UpdateTrackingCategoryResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *TrackingCategories) Delete(ctx context.Context, request operations.AccountingTrackingCategoriesDeleteRequest, opts ...operations.Option) (*operations.AccountingTrackingCategoriesDeleteResponse, error) {
	...
	res := &operations.AccountingTrackingCategoriesDeleteResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.DeleteTrackingCategoryResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.DeleteTrackingCategoryResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
