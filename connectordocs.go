...
func newConnectorDocs(rootSDK *Apideck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *ConnectorDocs {
...
func (s *ConnectorDocs) Get(ctx context.Context, id string, docID string, appID *string, opts ...operations.Option) (*operations.ConnectorConnectorDocsOneResponse, error) {
	...
	globals := operations.ConnectorConnectorDocsOneGlobals{
	...
	if o.AcceptHeaderOverride != nil {
		...
		req.Header.Set("Accept", "application/json;q=1, text/markdown;q=0")
	}
	...
	res := &operations.ConnectorConnectorDocsOneResponse{
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `text/markdown`):
			...
			out := string(rawBody)
			res.GetConnectorDocResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
