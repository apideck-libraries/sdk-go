...
func newPipelines(rootSDK *Apideck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Pipelines {
	return &Pipelines{
		rootSDK:          rootSDK,
...
// Create pipeline
// Create pipeline
func (s *Pipelines) Create(ctx context.Context, request operations.CrmPipelinesAddRequest, opts ...operations.Option) (*operations.CrmPipelinesAddResponse, error) {
...
// Get pipeline
// Get pipeline
func (s *Pipelines) Get(ctx context.Context, request operations.CrmPipelinesOneRequest, opts ...operations.Option) (*operations.CrmPipelinesOneResponse, error) {
...
// Update pipeline
// Update pipeline
func (s *Pipelines) Update(ctx context.Context, request operations.CrmPipelinesUpdateRequest, opts ...operations.Option) (*operations.CrmPipelinesUpdateResponse, error) {
...
// Delete pipeline
// Delete pipeline
func (s *Pipelines) Delete(ctx context.Context, request operations.CrmPipelinesDeleteRequest, opts ...operations.Option) (*operations.CrmPipelinesDeleteResponse, error) {
