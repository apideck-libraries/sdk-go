...
func newOrders(rootSDK *Apideck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Orders {
	return &Orders{
		rootSDK:          rootSDK,
...
func (s *Orders) List(ctx context.Context, request operations.EcommerceOrdersAllRequest, opts ...operations.Option) (*operations.EcommerceOrdersAllResponse, error) {
	...
	res := &operations.EcommerceOrdersAllResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	}
	res.Next = func() (*operations.EcommerceOrdersAllResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetEcommerceOrdersResponse
...
func (s *Orders) Get(ctx context.Context, request operations.EcommerceOrdersOneRequest, opts ...operations.Option) (*operations.EcommerceOrdersOneResponse, error) {
	...
	res := &operations.EcommerceOrdersOneResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetEcommerceOrderResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
