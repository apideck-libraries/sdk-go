...
func newBalanceSheet(rootSDK *Apideck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *BalanceSheet {
	return &BalanceSheet{
		rootSDK:          rootSDK,
...
func (s *BalanceSheet) Get(ctx context.Context, request operations.AccountingBalanceSheetOneRequest, opts ...operations.Option) (*operations.AccountingBalanceSheetOneResponse, error) {
	...
	res := &operations.AccountingBalanceSheetOneResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetBalanceSheetResponse
