...
// List Companies
// List Companies
func (s *ApideckHrisCompanies) List(ctx context.Context, request operations.HrisCompaniesAllRequest, opts ...operations.Option) (*operations.HrisCompaniesAllResponse, error) {
