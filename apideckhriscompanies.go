...
type ApideckHrisCompanies struct {
	rootSDK          *Apideck
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newApideckHrisCompanies(rootSDK *Apideck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *ApideckHrisCompanies {
	return &ApideckHrisCompanies{
		rootSDK:          rootSDK,
...
// All - List Companies
// List Companies
func (s *ApideckHrisCompanies) All(ctx context.Context, request operations.HrisCompaniesAll2Request, opts ...operations.Option) (*operations.HrisCompaniesAll2Response, error) {
	globals := operations.HrisCompaniesAll2Globals{
	...
	res := &operations.HrisCompaniesAll2Response{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	}
	res.Next = func() (*operations.HrisCompaniesAll2Response, error) {
		...
		return s.All(
			ctx,
			operations.HrisCompaniesAll2Request{
				Raw:         request.Raw,
...
// Create Company
// Create Company
func (s *ApideckHrisCompanies) Create(ctx context.Context, request operations.HrisCompaniesAddRequest, opts ...operations.Option) (*operations.HrisCompaniesAddResponse, error) {
...
// Get Company
// Get Company
func (s *ApideckHrisCompanies) Get(ctx context.Context, request operations.HrisCompaniesOneRequest, opts ...operations.Option) (*operations.HrisCompaniesOneResponse, error) {
...
// Update Company
// Update Company
func (s *ApideckHrisCompanies) Update(ctx context.Context, request operations.HrisCompaniesUpdateRequest, opts ...operations.Option) (*operations.HrisCompaniesUpdateResponse, error) {
...
// Delete Company
// Delete Company
func (s *ApideckHrisCompanies) Delete(ctx context.Context, request operations.HrisCompaniesDeleteRequest, opts ...operations.Option) (*operations.HrisCompaniesDeleteResponse, error) {
