...
func newDepartments(rootSDK *Apideck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Departments {
	return &Departments{
		rootSDK:          rootSDK,
...
// List Departments
// List Departments
func (s *Departments) List(ctx context.Context, request operations.AccountingDepartmentsAllRequest, opts ...operations.Option) (*operations.AccountingDepartmentsAllResponse, error) {
	globals := operations.AccountingDepartmentsAllGlobals{
	...
	opURL, err := url.JoinPath(baseURL, "/accounting/departments")
	if err != nil {
	...
	res := &operations.AccountingDepartmentsAllResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	}
	res.Next = func() (*operations.AccountingDepartmentsAllResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetAccountingDepartmentsResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.GetAccountingDepartmentsResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Departments) Create(ctx context.Context, request operations.AccountingDepartmentsAddRequest, opts ...operations.Option) (*operations.AccountingDepartmentsAddResponse, error) {
	...
	res := &operations.AccountingDepartmentsAddResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.CreateAccountingDepartmentResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.CreateAccountingDepartmentResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Departments) Get(ctx context.Context, request operations.AccountingDepartmentsOneRequest, opts ...operations.Option) (*operations.AccountingDepartmentsOneResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/accounting/departments/{id}", request, globals)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.AccountingDepartmentsOneResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetAccountingDepartmentResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.GetAccountingDepartmentResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Departments) Update(ctx context.Context, request operations.AccountingDepartmentsUpdateRequest, opts ...operations.Option) (*operations.AccountingDepartmentsUpdateResponse, error) {
	...
	res := &operations.AccountingDepartmentsUpdateResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.UpdateAccountingDepartmentResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.UpdateAccountingDepartmentResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Departments) Delete(ctx context.Context, request operations.AccountingDepartmentsDeleteRequest, opts ...operations.Option) (*operations.AccountingDepartmentsDeleteResponse, error) {
	...
	res := &operations.AccountingDepartmentsDeleteResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.DeleteAccountingDepartmentResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.DeleteAccountingDepartmentResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
