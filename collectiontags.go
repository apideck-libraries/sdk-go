...
func newCollectionTags(rootSDK *Apideck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *CollectionTags {
...
func (s *CollectionTags) List(ctx context.Context, request operations.IssueTrackingCollectionTagsAllRequest, opts ...operations.Option) (*operations.IssueTrackingCollectionTagsAllResponse, error) {
	...
	res := &operations.IssueTrackingCollectionTagsAllResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	}
	res.Next = func() (*operations.IssueTrackingCollectionTagsAllResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetCollectionTagsResponse
