...
func newAgedDebtors(rootSDK *Apideck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *AgedDebtors {
	return &AgedDebtors{
		rootSDK:          rootSDK,
...
func (s *AgedDebtors) Get(ctx context.Context, request operations.AccountingAgedDebtorsOneRequest, opts ...operations.Option) (*operations.AccountingAgedDebtorsOneResponse, error) {
	...
	res := &operations.AccountingAgedDebtorsOneResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetAgedDebtorsResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.GetAgedDebtorsResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
