...
func newStores(rootSDK *Apideck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Stores {
	return &Stores{
		rootSDK:          rootSDK,
...
func (s *Stores) Get(ctx context.Context, request operations.EcommerceStoresOneRequest, opts ...operations.Option) (*operations.EcommerceStoresOneResponse, error) {
	...
	res := &operations.EcommerceStoresOneResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetStoreResponse
