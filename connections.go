...
func newConnections(rootSDK *Apideck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Connections {
	return &Connections{
		rootSDK:          rootSDK,
...
func (s *Connections) List(ctx context.Context, consumerID *string, appID *string, api *string, configured *bool, opts ...operations.Option) (*operations.VaultConnectionsAllResponse, error) {
	...
	globals := operations.VaultConnectionsAllGlobals{
	...
	res := &operations.VaultConnectionsAllResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetConnectionsResponse
...
func (s *Connections) Get(ctx context.Context, serviceID string, unifiedAPI string, consumerID *string, appID *string, opts ...operations.Option) (*operations.VaultConnectionsOneResponse, error) {
	...
	globals := operations.VaultConnectionsOneGlobals{
		ConsumerID: s.sdkConfiguration.Globals.ConsumerID,
		AppID:      s.sdkConfiguration.Globals.AppID,
	}
	...
	res := &operations.VaultConnectionsOneResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
...
func (s *Connections) Update(ctx context.Context, request operations.VaultConnectionsUpdateRequest, opts ...operations.Option) (*operations.VaultConnectionsUpdateResponse, error) {
	...
	res := &operations.VaultConnectionsUpdateResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
...
func (s *Connections) Delete(ctx context.Context, serviceID string, unifiedAPI string, consumerID *string, appID *string, opts ...operations.Option) (*operations.VaultConnectionsDeleteResponse, error) {
	...
	globals := operations.VaultConnectionsDeleteGlobals{
		ConsumerID: s.sdkConfiguration.Globals.ConsumerID,
		AppID:      s.sdkConfiguration.Globals.AppID,
	}
	...
	res := &operations.VaultConnectionsDeleteResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
...
func (s *Connections) Imports(ctx context.Context, request operations.VaultConnectionsImportRequest, opts ...operations.Option) (*operations.VaultConnectionsImportResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/vault/connections/{unified_api}/{service_id}/import", request, globals)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.VaultConnectionsImportResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.CreateConnectionResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *Connections) Migrate(ctx context.Context, request operations.VaultConnectionsMigrateRequest, opts ...operations.Option) (*operations.VaultConnectionsMigrateResponse, error) {
	globals := operations.VaultConnectionsMigrateGlobals{
		ConsumerID: s.sdkConfiguration.Globals.ConsumerID,
		AppID:      s.sdkConfiguration.Globals.AppID,
	}
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/vault/connections/{unified_api}/{service_id}/migrate", request, globals)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "vault.connectionsMigrate",
		OAuth2Scopes:     nil,
		SecuritySource:   s.sdkConfiguration.Security,
	}
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "ConnectionMigrateData", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	res := &operations.VaultConnectionsMigrateResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 409:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out apierrors.ConflictResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *Connections) Token(ctx context.Context, request operations.VaultConnectionsTokenRequest, opts ...operations.Option) (*operations.VaultConnectionsTokenResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/vault/connections/{unified_api}/{service_id}/token", request, globals)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.VaultConnectionsTokenResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
