...
type ConsumerRequestCounts struct {
	rootSDK          *Apideck
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newConsumerRequestCounts(rootSDK *Apideck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *ConsumerRequestCounts {
...
func (s *ConsumerRequestCounts) List(ctx context.Context, consumerID string, startDatetime string, endDatetime string, appID *string, opts ...operations.Option) (*operations.VaultConsumerRequestCountsAllResponse, error) {
	...
	globals := operations.VaultConsumerRequestCountsAllGlobals{
	...
	res := &operations.VaultConsumerRequestCountsAllResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.ConsumerRequestCountsInDateRangeResponse
