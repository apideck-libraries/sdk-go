...
func newApplications(rootSDK *Apideck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Applications {
	return &Applications{
		rootSDK:          rootSDK,
...
func (s *Applications) List(ctx context.Context, request operations.AtsApplicationsAllRequest, opts ...operations.Option) (*operations.AtsApplicationsAllResponse, error) {
	...
	res.Next = func() (*operations.AtsApplicationsAllResponse, error) {
