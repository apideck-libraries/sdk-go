...
type ConnectionCustomMappings struct {
	rootSDK          *Apideck
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newConnectionCustomMappings(rootSDK *Apideck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *ConnectionCustomMappings {
...
func (s *ConnectionCustomMappings) List(ctx context.Context, request operations.VaultConnectionCustomMappingsAllRequest, opts ...operations.Option) (*operations.VaultConnectionCustomMappingsAllResponse, error) {
	...
	res := &operations.VaultConnectionCustomMappingsAllResponse{
