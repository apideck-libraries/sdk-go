...
func newLists(rootSDK *Apideck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Lists {
	return &Lists{
		rootSDK:          rootSDK,
...
// List lists
// List lists
func (s *Lists) List(ctx context.Context, request operations.CrmListsAllRequest, opts ...operations.Option) (*operations.CrmListsAllResponse, error) {
	globals := operations.CrmListsAllGlobals{
	...
	opURL, err := url.JoinPath(baseURL, "/crm/lists")
	if err != nil {
	...
	res := &operations.CrmListsAllResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	}
	res.Next = func() (*operations.CrmListsAllResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetListsResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.GetListsResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
// Get list
// Get list
func (s *Lists) Get(ctx context.Context, request operations.CrmListsOneRequest, opts ...operations.Option) (*operations.CrmListsOneResponse, error) {
	globals := operations.CrmListsOneGlobals{
		ConsumerID: s.sdkConfiguration.Globals.ConsumerID,
		AppID:      s.sdkConfiguration.Globals.AppID,
	}
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/crm/lists/{id}", request, globals)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.CrmListsOneResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetListResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.GetListResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
