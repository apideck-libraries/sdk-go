...
func newProfitAndLoss(rootSDK *Apideck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *ProfitAndLoss {
...
func (s *ProfitAndLoss) Get(ctx context.Context, request operations.AccountingProfitAndLossOneRequest, opts ...operations.Option) (*operations.AccountingProfitAndLossOneResponse, error) {
	...
	res := &operations.AccountingProfitAndLossOneResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetProfitAndLossResponse
